    ...
    <body>
        ...
        foreach ($profiles as $profile) {
            ...
            if ($profile->profileID == $_POST['profileID']) {
                ...
                array_push($profile->allergies, $allergy);
        ...
        if (empty($insert))
            header("Location: http://" . redirectLink()  . "/SafeFront/index.php?action=profileAllergies&profileID=".$_POST['profileID']."&method=Allergy%20added%20Sucessfully"); /* Redirect browser */
        else {
            echo $insert;
        }
        ?>
