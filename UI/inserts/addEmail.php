    ...
    <body>
        ...
        foreach ($profiles as $profile) {
            ...
            if ($profile->profileID == $_POST['profileID']) {
                ...
                array_push($profile->emails, $email);
        ...
        if (empty($insert))
            header("Location: http://" . redirectLink()  . "/SafeFront/index.php?action=profileEmails&profileID=".$_POST['profileID']."&method=Email%20added%20Sucessfully"); /* Redirect browser */
        else {
            echo $insert;
        }
        ?>
